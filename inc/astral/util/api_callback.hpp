...
#ifndef ASTRAL_API_CALLBACK_HPP
#define ASTRAL_API_CALLBACK_HPP
 ...
 */
   ...
   *
   * This class is used by the astral::gl_binding and can be
   * reused for other 3D API's (by definding a macro for each
   * 3D API function that pre-calls to APICallbackSet::pre_call()
   * and post-calls to APICallbackSet::post_call() around each
   * 3D API function call.
   */
  class APICallbackSet:astral::noncopyable
  {
  public:
    /*!
     * \brief
